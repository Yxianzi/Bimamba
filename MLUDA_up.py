...
for iDataSet in range(nDataSet):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(1,num_iter):
            ...
            loss = cls_loss + 0.3 * lambd * got_loss + domain_similar_loss
        ...
        print(
            'epoch {:>3d}:   cls loss: {:6.4f}, got loss: {:6.4f}, occ loss: {:6.4f}, acc {:6.4f}, total loss: {:6.4f}'
            .format(epoch, cls_loss.item(), got_loss.item(), domain_similar_loss.item(), total_hit / size, loss.item()))
